...
internal class AMSI_Provider
{
    ...
    [DllImport("Amsi.dll", EntryPoint = "AvApp", CallingConvention = CallingConvention.StdCall)]
    ...
    public void CallAntimalwareScanInterface()
    {
        IntPtr amsiContext;
        IntPtr session;
        AMSI_RESULT result = 0;
        int returnValue;
        returnValue = AmsiInitialize("AvApp", out amsiContext); //appName is the name of the application consuming the Amsi.dll. Here my project name is VirusScanAPI.   
